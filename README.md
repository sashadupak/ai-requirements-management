...
Проект AutoProm AI создавался на основе практического исследования процессов управления требованиями в промышленной разработке.

Были изучены существующие процессы в автомобильной отрасли, проведён анализ зарубежных и российских систем управления требованиями, а также собран набор данных от подрядчиков для обработки.

Особое внимание было уделено работе с неструктурированными инженерными документами. В качестве исходных данных использовались:

- Техническая документация поставщиков и подрядчиков;
- спецификации компонентов от зарубежных производителей, включая документацию из Китая;
- нормативная документация и государственные стандарты (ГОСТ);
- внутренние требования и проектная документация.

Размер отдельных документов достигал десятков страниц. Например, некоторые нормативные документы содержали более 50 страниц требований, ограничений и методик проверки, которые инженерам приходится анализировать вручную.
...
<img src="assets/tesla.jpg" alt="Пример несоответствия требований и реализации в автомобильном интерфейсе" height="200">
...
<img src="assets/problemgraph.jpg" alt="Масштаб проблемы управления требованиями" height="200">
...
<img src="assets/nasacrash.jpg" alt="Mars Climate Orbiter" height="200">
...
<img src="assets/stockfall.jpg" alt="Knight Capital Group incident" height="200">
...
<img src="assets/market_int.jpg" alt="Международные конкуренты" height="200">

*Сравнение ведущих мировых решений для управления требованиями.*

### Российские решения

<img src="assets/market_russ.jpg" alt="Российские конкуренты" height="200">
...
<img src="assets/devpromnew.jpg" alt="Интерфейс Devprom ALM" height="200">
...
<img src="assets/dashboard.jpg" alt="Главный экран AutoProm AI" height="200">
...
<img src="assets/reqs_tree.jpg" alt="Дерево требований" height="200">

*Иерархия требований и автоматическое отслеживание связей между элементами системы.*

### Работа с требованиями

<img src="assets/req_description.jpg" alt="Карточка требования" height="200">
...
<img src="assets/stakeholder example.jpg" alt="Конфликт требований и рекомендации ИИ" height="200">
...
<img src="assets/porsche.jpg" alt="Исследование Porsche" height="200">
...
<img src="assets/ai-hack.jpg" alt="цифровой прорыв" height="200">

*Выступление перед аудиторией участников хакатона Цифровой Прорыв с задачей автоматизации проверки требований в сертифицируемом контуре.*
